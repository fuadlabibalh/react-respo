...
export declare const useResponsive: () => (styleDef: (context: style_sheet.CssElementContext) => React.CSSProperties, ...setConds: style_sheet.setCondision[]) => React.CSSProperties;
declare const cssrr: {
    ...
    useCurrentDimension: () => device_screen.ScreenDimension;
    useAvlDimension: () => device_screen.ScreenDimension;
    useResponsive: () => (styleDef: (context: style_sheet.CssElementContext) => React.CSSProperties, ...setConds: style_sheet.setCondision[]) => React.CSSProperties;
};
