...
export declare const useResponsive: () => (styleDef: (device: device_screen.DeviceScreens) => React.CSSProperties, ...setConds: style_sheet.setCondision[]) => import("react").CSSProperties;
declare const cssrr: {
    ...
    useCurrentDimension: () => device_screen.ScreenDimension;
    useAvlDimension: () => device_screen.ScreenDimension;
    useResponsive: () => (styleDef: (device: device_screen.DeviceScreens) => React.CSSProperties, ...setConds: style_sheet.setCondision[]) => import("react").CSSProperties;
};
